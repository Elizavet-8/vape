            ...
            btn.addEventListener('click', () => {
                ...
                if( window.innerWidth > 999 ){
                    ...
                    drop.addEventListener('click', () => {
                        document.querySelector('.drop__cont').onmouseleave = function(event) {
                            document.querySelectorAll('.burger__btn')[0].classList.remove('active');
                            document.querySelectorAll('.dropdowns')[0].classList.remove('active');
                        };
                    })
                }
